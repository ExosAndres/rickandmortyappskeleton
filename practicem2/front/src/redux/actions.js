...
export const getAllCharacters = ()=>{ // siempre que queramos solicitar info a un server, es decir que vamos a usar 
    //fetch o axios, la action retorna a otra funcion e interviene el middleWare
